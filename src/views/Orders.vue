<template>
  <div class="card">
    <h5>جميع الطلبات</h5>
    <DataView :value="orders" :paginator="false">
              ...
              <div class="flex flex-column md:flex-row justify-content-between md:align-items-center flex-1 gap-4">
                <div class="flex flex-row md:flex-column justify-content-between align-items-start gap-2">
                  ...
                  <div>
                    ...
                    <Tag v-else-if="item.status === 2" class="mr-2" severity="success" value="تم"></Tag>
...
onMounted(async () => {
  ...
  data.forEach(async ord => {
    const { data: service } = await axios.get('services/'+ord.service_id)
    ord.service = service
  })
  orders.value = data
})
